...
init env initMsg =
    Data
        [ Rect.component (RectangleInit <| RectMsg.Init 100 100 200 200 Color.yellow 0) env
        , Rect.component (RectangleInit <| RectMsg.Init 250 250 200 200 Color.green 1) env
        ]
