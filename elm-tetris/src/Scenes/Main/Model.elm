...
import Scenes.Main.GameLayer.Global as GameLayerG
import Scenes.Main.LayerBase exposing (CommonData, LayerInitData(..), nullCommonData)
import Scenes.Main.UILayer.Export as UILayer
import Scenes.Main.UILayer.Global as UILayerG
...
initModel env _ =
    ...
    , layers =
        ...
        , UILayerG.getLayerT <| UILayer.initLayer (addCommonData nullCommonData env) NullLayerInitData
        ]
    }
