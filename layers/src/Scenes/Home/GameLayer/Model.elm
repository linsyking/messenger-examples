...
initModel env _ =
    { components =
        Array.fromList
            [ Rect.initComponent (noCommonData env) (ComponentID 0 (RectInitData 100 100 200 200 Color.blue))
            , Rect.initComponent (noCommonData env) (ComponentID 1 (RectInitData 250 250 200 200 Color.red))
            ]
    }
